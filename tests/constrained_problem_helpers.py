...
convex_constrained_paraboloids = (
    ...
    (
        ...
        _Point(1.0, 0.0),
        None,
        lambda y: 2 + y.a - 3 * y.b,  # 2 + x - 3 * y >= 0.
        _Point(0.0, 0.0),
    ),
    ...
    (
        ...
        (1.0, jnp.array([-1.0])),
        None,
        lambda y: -2 + y[0] - 3 * y[1],  # -2 + x - 3 * y >= 0.
        (0.2, jnp.array([-0.6])),
    ),
    ...
    (
        ...
        jnp.array([-2.0, -1.0]),
        None,
        lambda y: jnp.sin(y[0]) - y[1],  # y <= sin(x)
        jnp.array([0.0, 0.0]),
    ),
)
...
minimise_fn_y0_args_constraint_expected_result = (
    ...
    (
        ...
        (1.0, 0.0),
        None,
        lambda y: jnp.array([1.2 - y[1], 1.2 - y[0]]),  # y <= 1.2
        (1.0, 1.0),
    ),
    (
        scalar_rosenbrock,
        (1.0, 0.0),
        None,
        lambda y: jnp.sin(y[0]) + 0.2 - y[1],  # y <= sin(x) + 0.2
        (1.0, 1.0),
    ),
    (
        scalar_rosenbrock,
        (1.0, 0.0),
        None,
        lambda y: y[0] + 0.01 - y[1],  # y <= x + 0.1, constraint along line y0 -> min
        (1.0, 1.0),
    ),
    (
        scalar_rosenbrock,
        ...
        lambda y: y[0] ** 2
        + 0.1
        - y[1],  # y <= x**2 + 0.1, path exactly along parabola
        (1.0, 1.0),
    ),
)
