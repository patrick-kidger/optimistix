...
#     )
#     operator = _make_lbfgs_operator(state)
#     assert tree_allclose(operator.as_matrix(), hess_inv_hist)
...
#     history_len = len(inner_history)
#     update = LBFGSUpdate(
#         history_length=history_len + extra_history, use_inverse=False
#     )
...
#         ),
#         y_diff_cross_inner=state_init.y_diff_cross_inner.at[:history_len,
# :history_len].set(
...
#     assert state_long_hist.y_diff_grad_diff_cross_inner.shape[0]
# == history_len + extra_history
#     assert state_long_hist.y_diff_grad_diff_inner.shape[0] == history_len +
# extra_history
