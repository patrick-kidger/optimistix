...
ax.plot_surface(x_values, y_values, z_values, cmap="coolwarm")  # pyright: ignore
...
ax.set_zlabel("f(x, y)\n\n\n\n\n\n\n\n", labelpad=-30)  # pyright: ignore
ax.zaxis.set_rotate_label(False)  # pyright: ignore
ax.xaxis.set_pane_color((1.0, 1.0, 1.0, 1.0))  # pyright: ignore
ax.yaxis.set_pane_color((1.0, 1.0, 1.0, 1.0))  # pyright: ignore
ax.zaxis.set_pane_color((1.0, 1.0, 1.0, 1.0))  # pyright: ignore
