...
class AbstractGaussNewton(AbstractLeastSquaresSolver[Y, Out, Aux, _GaussNewtonState]):
    ...
    def step(
        ...
        self.verbose(
            ...
            steps_since_acceptance=("Steps since acceptance", state.num_steps_since_acceptance),
...
- `verbose`: Whether to print out extra information about how the solve is proceeding.
    ...
    each value will be a 2-tuple of `(str, Any)` providing a human-readable name and its
    corresponding value.
"""
