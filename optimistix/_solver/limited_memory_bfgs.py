...
def roll_low_triangular_matrix(array, new_vals, index_start):
    ...
    **Returns**:
    ...
    # TODO(jhaffner) needs addressing https://github.com/patrick-kidger/optimistix/pull/135#discussion_r2147340601
    return jax.lax.cond(
        index_start < array.shape[0], _set_at_index, _roll_and_set, array, new_vals
    )


# TODO(haffner): type annotations https://github.com/patrick-kidger/optimistix/pull/135#discussion_r2147340058
...
def _lbfgs_hessian_operator_fn(
    ...
    # TODO(jhaffner): Needs addressing https://github.com/patrick-kidger/optimistix/pull/135#discussion_r2147342004
