...
class Eval(FunctionInfo, Generic[Y, EqualityOut, InequalityOut], strict=True):
    ...
    constraint_residual: Union[tuple[EqualityOut, InequalityOut], None]
...
class EvalGradHessian(
    FunctionInfo, Generic[Y, EqualityOut, InequalityOut], strict=True
):
    ...
    constraint_residual: Union[tuple[EqualityOut, InequalityOut], None]
    constraint_bounds: Union[tuple[EqualityOut, InequalityOut], None]
    ...
    def to_linear_constraints(
        self,
    ) -> Union[Callable[[Y], tuple[EqualityOut, InequalityOut]], None]:
